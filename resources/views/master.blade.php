                ...
                <div class="col-lg-8">
                    ...
                    <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Experience:</span>{{$about->experience}} Years
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Phone:</span> {{$about->phone}}
                            </div>
                            <div class="col-sm-6 py-1">
                                <span class="fw-medium text-primary">Email:</span> {{$about->email}}
                            </div>
                            <div class="col-sm-6 py-1">
                        ...
                        <div class="row g-4">
                            ...
                            <div class="col-md-4 col-lg-6 col-xl-4">
                                <div class="d-flex bg-secondary p-4">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">{{$about->happyClients}}</h1>
                                    <div class="ps-3">
                            ...
                            <div class="col-md-4 col-lg-6 col-xl-4">
                                <div class="d-flex bg-secondary p-4">
                                    <h1 class="flex-shrink-0 display-5 text-primary mb-0" data-toggle="counter-up">{{$about->completeProjects}}</h1>
                                    <div class="ps-3">
                    ...
                    <section class="py-5 border-bottom wow fadeInUp" data-wow-delay="0.1s">
                        ...
                        <div class="owl-carousel testimonial-carousel">
                            ...
                            <div class="text-left">
                                ...
                                <p class="fs-4 mb-4">{{$testimonial->text}}</p>
                                <div class="d-flex align-items-center">
                                    <img class="img-fluid" src="img/testimonial-1.jpg" style="width: 60px; height: 60px;">
                                    <div class="ps-3">
                                        <p class="text-primary fs-5 mb-1">{{$testimonial->client_name}}</p>
                                        <i>Profession</i>
                                    </div>
                                </div>
                            @endforeach
